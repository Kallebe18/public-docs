...
![Gerar Boleto](../../.gitbook/assets/8-vendas.png)
...
![](../../.gitbook/assets/9-vendas.png)

### Notas Fiscais

Para gerar a nota fiscal para venda, utilize um tipo de movimentação com a opção _Gera Fiscal_ ativa, após isso ao confirmar a venda o botão **`Gera NF`** estará disponível, selecione-o para que o pdf e xml sejam gerados, você pode baixá-los através da aba **Anexos**.
